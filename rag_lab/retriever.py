...
def retrieve(
    ...
    chunks = []
    search_collections = collections or _resolve_collections()
    ...
    for i in range(max_iters):
        ...
        chunks = vector_store.query_multi(q_vec, collections=search_collections, top_k=top_k)[:rerank_top]
